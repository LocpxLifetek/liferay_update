...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.display-name=SearchBlogs", "javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/searchBlogs.jsp",
		"javax.portlet.name=" + GovermentPortletKeys.SEARCHBLOGSGOVERMENT,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user" }, service = Portlet.class)

public class SearchBlogs extends MVCPortlet {
	@Override
