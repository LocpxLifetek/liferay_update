  ...
  <head>
    ...
    <style>
      ...
      .brand-text h2 {
        ...
        font-weight: 600;
        color: #fd9b08;
        text-shadow: 0px 1px 0px #fff, 1px 0px 0px #fff, -1px 0px 0px #fff,
      ...
      .header-menu-item:hover .header-menu-sub-wrapper,
      .header-menu-item:hover .header-menu-triangle-wrapper {
        display: block;
      }

      .header-menu-item.active .header-menu-sub-wrapper,
      .header-menu-item.active .header-menu-triangle-wrapper {
        display: block;
      }
      ...
      .header-menu-sub-item:not(:first-child) {
        padding-left: 15px;
      }

      .header-menu-sub-item:hover .title-menu,
      .header-menu-sub-item.sub-active .title-menu {
        color: #0083f3;
      }
      ...
      .icon-search {
        background: url('<%=request.getContextPath()%>/images/portal/images/search.png') no-repeat left top;
        width: 16px;
        height: 16px;
        display: block;
        border: none;
  ...
  <body>
    <div class="header-fixed">
      <div class="header" style="background-image: url('<%=request.getContextPath()%>/images/portal/_res/img/bg-header-min.jpg');">
        ...
        <!-- btn search -->
        <div class="header-menu-search-wrapper" style="right: 20%; top: 16px">
          <div>
            <input
              id="keySearch"
              type="text"
              name="key"
              class="header-menu-search-box"
      ...
      <!-- Menu -->
      <div
        class="header-menu-wrapper hidden-xs"
        style="
          background: linear-gradient(#2464b0, #185090, #204f86);
          box-shadow: inset 0px 1px 0px rgb(255 255 255 / 35%);
          border-top: 1px solid #204f86;
        "
      >
        <div style="height: 47.219px; z-index: 1; margin: auto; width: 1200px">
          <ul
            class="header-menu"
                  ...
                  <div class="portlet-content-container">
                    <div class="portlet-body" style="padding-top: 3px">
                      ...
                      >
                        ...
                        >
                          YouTube bị cáo buộc truyền tải thông tin sai lệch
                        </a>
                        <a
                        ...
                        >
                          Trung Quốc yêu cầu các ứng dụng “có ảnh hưởng” phải
                          được đánh giá bảo mật
                        </a>
                        <span>*</span>
                        <a
                        ...
                        >
                          Đồng loạt cảnh báo nạn tin nhắn lừa đảo mạo danh ngân
                          hàng, BHXH</a
                        >
                        <span>*</span>
                        <a
                        ...
                        >
                          ...
                          truyền thống trong thời đại 4.0
                        </a>
                        <span>*</span>
                      </marquee>
                    </div>
