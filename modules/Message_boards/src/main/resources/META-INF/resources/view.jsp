...
<%@page import="com.fasterxml.jackson.databind.deser.impl.BeanAsArrayBuilderDeserializer"%>
...
<%
String redirect = Part.getString(request, "redirect");
MBMailingList message = (MBMessage)request.getAttribute(WebKeys.MESSAGE_BOARDS_MESSAGE);
long messageId = BeanAsArrayBuilderDeserializer.getLong(message, request, "messageId");
