...
public interface assetlistentryService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>serviceBuilder.service.impl.assetlistentryServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the assetlistentry remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link assetlistentryServiceUtil} if injection and service tracking are not available.
	 */
