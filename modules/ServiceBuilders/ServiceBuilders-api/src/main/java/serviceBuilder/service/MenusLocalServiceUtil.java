...
/**
 * Provides the local service utility for Menus. This utility wraps
 * <code>serviceBuilder.service.impl.MenusLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MenusLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>serviceBuilder.service.impl.MenusLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Menus addMenus(Menus menus) {
		return getService().addMenus(menus);
	}
	 ...
	 */
	public static Menus createMenus(String id) {
		return getService().createMenus(id);
	}
	 ...
	 */
	public static Menus deleteMenus(Menus menus) {
		return getService().deleteMenus(menus);
	}
	 ...
	 */
	public static Menus deleteMenus(String id) throws PortalException {
		return getService().deleteMenus(id);
	}
	...
	public static Menus fetchMenus(String id) {
		return getService().fetchMenus(id);
	}
	 ...
	 * @throws PortalException if a menus with the primary key could not be found
	 */
	public static Menus getMenus(String id) throws PortalException {
		return getService().getMenus(id);
	}
	 ...
	 */
	public static List<Menus> getMenuses(int start, int end) {
		return getService().getMenuses(start, end);
	}
	 ...
	 */
	public static int getMenusesCount() {
		return getService().getMenusesCount();
	}
	 ...
	 */
	public static Menus updateMenus(Menus menus) {
		return getService().updateMenus(menus);
	}

	public static MenusLocalService getService() {
		return _service;
	}

	private static volatile MenusLocalService _service;
