...
public interface assetlistentryLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>serviceBuilder.service.impl.assetlistentryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the assetlistentry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link assetlistentryLocalServiceUtil} if injection and service tracking are not available.
	 */
