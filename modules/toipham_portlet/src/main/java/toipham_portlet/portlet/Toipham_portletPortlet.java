...
import toipham_portlet.constants.Toipham_portletPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.name=" + Toipham_portletPortletKeys.TOIPHAM_PORTLET,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class Toipham_portletPortlet extends MVCPortlet {
