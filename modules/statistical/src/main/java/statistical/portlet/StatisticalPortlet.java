...
import statistical.constants.StatisticalPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Statistical",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + StatisticalPortletKeys.STATISTICAL,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class StatisticalPortlet extends MVCPortlet {
