package com.Test.Thoi.portlet;

import com.Test.Thoi.constants.testThoiPortletKeys;
...
@Component(immediate = true, property = { "com.liferay.portlet.display-category=category.sample",
		...
		"javax.portlet.display-name=testThoi", "javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp", "javax.portlet.name=" + testThoiPortletKeys.TESTTHOI,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user" }, service = Portlet.class)
public class testThoiPortlet extends MVCPortlet {
